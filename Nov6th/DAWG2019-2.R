...
# 2) Run randomforest using parameters from 1)
...
# usage
packages <- c("doParallel", "randomForest", "mlbench", "caret", "e1071","pROC","phyloseq","ggplot2")
ipak(packages)
...
genus_level <- taxa_level(ps.pruned, "Genus")
